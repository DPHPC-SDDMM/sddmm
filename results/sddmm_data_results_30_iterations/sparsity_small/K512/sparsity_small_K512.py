...
def plot_result_data(result_data):
    plt.scatter(x=result_data['base']['sparsity'], y=result_data['base']['elapsed_time'])
    plt.scatter(x=result_data['cuSparse']['sparsity'], y=result_data['cuSparse']['elapsed_time'])
    plt.scatter(x=result_data['sm_l2']['sparsity'], y=result_data['sm_l2']['elapsed_time'])
    plt.xlabel('Sparsity')
...
def plot_box_plot(result_data):
    ...
    sns.boxplot(x=result_data['base']['sparsity'], y=result_data['base']['elapsed_time'], whis=0.5, ax=axs[0])

    axs[1].set_title('cuSPARSE')
    sns.boxplot(x=result_data['cuSparse']['sparsity'], y=result_data['cuSparse']['elapsed_time'], whis=0.5, ax=axs[1])

    axs[2].set_title('SM_L2')
    sns.boxplot(x=result_data['sm_l2']['sparsity'], y=result_data['sm_l2']['elapsed_time'], whis=0.5, ax=axs[2])
...
def plot_violin_plot(result_data):
    ...
    axs[0].set_title('Baseline')
    sns.violinplot(x=result_data['base']['sparsity'], y=result_data['base']['elapsed_time'], ax=axs[0])

    axs[1].set_title('cuSPARSE')
    sns.violinplot(x=result_data['cuSparse']['sparsity'], y=result_data['cuSparse']['elapsed_time'], ax=axs[1])

    axs[2].set_title('SM_L2')
    sns.violinplot(x=result_data['sm_l2']['sparsity'], y=result_data['sm_l2']['elapsed_time'], ax=axs[2])
