...
//     namespace Algo {
//         class SampleAlgo {
//             void compute_steps(Types::expmt_t* T1, Types::expmt_t* T2, int N, int M){
//                 int n_end = N-1;
//                 int m_end = M-1;
//                 int n=0;
//                 int m=0;
...
//             Types::expmt_t total_energy(Types::expmt_t* T, int N, int M){
//                 Types::expmt_t res = 0;
//                 for(int n=0; n<N; ++n){
//                     for(int m=0; m<M; ++m){
//                         res += T[n*N + m];
...
//             void init(Types::expmt_t* T, int N, int M){
//                 for(int n=0; n<N; ++n){
//                     for(int m=0; m<M; ++m){
//                         T[n*N + m] = 0.0;
//                     }
...
//             void swap(Types::expmt_t*& T1, Types::expmt_t*& T2){
//                 Types::expmt_t* tmp = T1;
//                 T1 = T2;
//                 T2 = tmp;
//             }
...
//                     data.runtimes.push_back(std::vector<Types::expmt_t>());
//                     for(int n=0; n<n_experiments; ++n){
//                         if(n%50==0) std::cout << " -- run experiment " << n << "/" << n_experiments << std::endl;
//                         int M = N;
//                         Types::expmt_t* T1 = new Types::expmt_t[N*M];
//                         Types::expmt_t* T2 = new Types::expmt_t[N*M];

//                         init(T1, N, M);
//                         init(T2, N, M);

//                         Types::expmt_t total_start_t1 = total_energy(T1, N, M);
//                         Types::expmt_t total_start_t2 = total_energy(T2, N, M);
...
//                         Types::expmt_t total_end_t1 = total_energy(T1, N, M);
//                         Types::expmt_t total_end_t2 = total_energy(T2, N, M);
