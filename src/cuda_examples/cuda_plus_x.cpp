...
namespace SDDMM {
    namespace CUDA_EXAMPLES {
        std::vector<SDDMM::Types::expmt_t> CuPlusX(std::vector<SDDMM::Types::expmt_t>& in, SDDMM::Types::expmt_t x){
            ...
            // before intended
            SDDMM::Types::expmt_t* in_d = nullptr;
            ...
            SDDMM::Types::vec_size_t len_d = sizeof(SDDMM::Types::expmt_t) * len;
            ...
            SDDMM::Types::expmt_t* out_d = nullptr;
            ...
            run_k(in_d, out_d, len, x);

            // declare output type
            std::vector<SDDMM::Types::expmt_t> out;
