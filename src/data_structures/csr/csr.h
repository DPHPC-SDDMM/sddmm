...
namespace SDDMM{
    ...
    */
    ...
    public:
        ...
        std::vector<vec_size_t> col_idx;
        std::vector<vec_size_t> row_ptr;
        vec_size_t n, m;
        ...
        friend std::ostream &operator<<(std::ostream &os, const CSR &mat) {
            ...
            os << "Values: ";
            for (double v : mat.values) os << v << " ";
            os << "\nCol idx: ";
            for (vec_size_t col : mat.col_idx) os << col << " ";
            os << "\nRow ptr: ";
            for (vec_size_t row : mat.row_ptr) os << row << " ";
            os << std::endl;
