...
//             public:
//             static Results::ExperimentData vary_naive(
//                 std::string what, 
//                 int cur_exp, 
//                 int tot_exp, 
...
//             static Results::ExperimentData vary_parallel(
//                 std::string what, 
//                 int cur_exp, 
//                 int tot_exp, 
//                 Results::ExperimentInfo& info, 
...
//             static Results::ExperimentData vary_cuda(
//                 std::string what, 
//                 int cur_exp, 
//                 int tot_exp, 
//                 Results::ExperimentInfo& info, 
...
//             static Results::ExperimentData vary_sl2(
//                 std::string what, 
//                 int cur_exp, 
//                 int tot_exp, 
//                 Results::ExperimentInfo& info, 
...
//                 // calculate stupid params
//                 auto params = Algo::SML2SDDMM::preparations()
//                 Types::vec_size_t n_max = info.n_experiment_iterations+1;
//                 for(Types::vec_size_t n=0; n<n_max; ++n){
//                     TEXT::Gadgets::print_progress(n, info.n_experiment_iterations);
